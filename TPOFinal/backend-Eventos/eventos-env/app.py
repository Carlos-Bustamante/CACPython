...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://cmontanobustaman:root2023@cmontanobustamante.mysql.pythonanywhere-services.com/cmontanobustaman$eventos'
